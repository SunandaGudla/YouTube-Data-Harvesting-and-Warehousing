...
icon = Image.open("C:\\Users\\sunan\\Desktop\\Youtube_logo.png")
...
api_key = "AIzaSyA7uNtCLhYFkpUFrzS9GnLCURyb-Ngzjes" #"AIzaSyAc5yh9GIFfaop4yMixH2KVqHZGuKpEAWU"
...
def insert_into_mysql():
    # Extract data from MongoDB (e.g., channel_details collection)
    channel_data = list(db.channel_details.find())
...
if selected == "Home":
    # Title Image
    st.image("C:\\Users\\sunan\\Desktop\\Youtube_logo.png")

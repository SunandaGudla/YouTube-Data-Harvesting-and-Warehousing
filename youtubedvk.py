...
if selected == "Home":
    ...
    col1.markdown("## :blue[Overview] : Retrieving YouTube channel data from the Google API, storing it in a MongoDB data lake, migrating and transforming data into a SQL database, then querying the data and displaying it in the Streamlit app.")
